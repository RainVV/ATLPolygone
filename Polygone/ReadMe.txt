========================================================================
    ACTIVE TEMPLATE LIBRARY : Polygone Project Overview
========================================================================

AppWizard has created this Polygone project for you to use as the starting point for
...
Polygone.idl
    ...
    This file will be processed by the MIDL compiler to generate:
        C++ interface definitions and GUID declarations (Polygone.h)
        GUID definitions                                (Polygone_i.c)
        A type library                                  (Polygone.tlb)
        Marshaling code                                 (Polygone_p.c and dlldata.c)

Polygone.h
    This file contains the C++ interface definitions and GUID declarations of the
    items defined in Polygone.idl. It will be regenerated by MIDL during compilation.
...
StdAfx.h, StdAfx.cpp
    ...
    named Polygone.pch and a precompiled types file named StdAfx.obj.
...
Polygoneps.vcxproj
	...
	dlldata.c, Polygone_i.c and Polygone_p.c which are required
	to build the proxy/stub DLL.

Polygoneps.vcxproj.filters
